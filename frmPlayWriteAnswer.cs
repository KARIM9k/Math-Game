...
namespace Math_Game
{
    public partial class frmPlayWriteAnswer : Form
    {
        private stGameInfo _gameInfo;
        private int _currentRound = 1;
        private int _currentPlayer = 1;
        private int TimeCounter = 0;
        public frmPlayWriteAnswer(stGameInfo gameInfo)
        {
            InitializeComponent();
            _gameInfo = gameInfo;
        }
        ...
        void ProcessUserAnswer(bool isTimeout = false)
        {
            timer1.Stop();

            if (isTimeout || TimeCounter >= _gameInfo.TimeLimit)
            {
        ...
        private void frmPlayWriteAnswer_Load(object sender, EventArgs e)
        {
            StartRound(); 
        }
